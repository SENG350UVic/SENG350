...
The main disadvantage with this design pattern is that it can be hard to understand the flow of control for an event, making debugging difficult. Decoupling each reactor-based component from one another causes this disadvantage, as an Event could be non-deterministically in any of the active components.

## Part 2: Additional System Design Patterns
